...
function renderHome(container) {
  ...
  container.innerHTML = `
    ...
    <footer class="site-footer">
      ...
      <p class="footer-tech">
        <a href="${appData.portfolio.profile.github || '#'}" target="_blank" style="text-decoration: underline;">GitHub</a>
      </p>
    </footer>
  `;
}
    ...
    <div class="about-card" style="margin-top: 1rem;">
      ...
      <div class="about-details">
        ...
        <div class="about-socials">
          <a href="${profile.github}" target="_blank" class="social-btn" aria-label="GitHub" title="GitHub">
